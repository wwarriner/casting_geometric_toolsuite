    ...
    methods ( Access = public )
        ...
        function value = get_objective_value( ...
            ...
            value = obj.objective_values( ...
                point_indices( THETA_INDEX ), ...
                point_indices( PHI_INDEX ), ...
                objective_index ...
                );
        ...
        function indices = get_grid_indices_from_decisions( obj, point )
            
            [ PHI_INDEX, THETA_INDEX ] = unit_sphere_plot_indices();
            
            phi_index = round( ...
                ( deg2rad( point( PHI_INDEX ) ) + pi ) ...
                * size( obj.phi_grid, 2 ) ...
                ./ ( 2 * pi ) ...
                );
            ...
            theta_index = round( ...
                ( deg2rad( point( THETA_INDEX ) ) + pi/2 ) ...
        ...
        function point = get_point_in_radians_from_indices( ...
                obj, ...
                indices ...
                )
            
            [ PHI_INDEX, THETA_INDEX ] = unit_sphere_plot_indices();
            point( PHI_INDEX ) = obj.phi_grid( 1, indices( PHI_INDEX ) );
            point( THETA_INDEX ) = obj.theta_grid( indices( THETA_INDEX ), 1 );
            
        end
        
        
        function point = get_point_in_degrees_from_indices( ...
                obj, ...
                indices ...
                )
            
            point = rad2deg( obj.get_point_in_radians_from_indices( indices ) );
