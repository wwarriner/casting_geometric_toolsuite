classdef (Sealed) UnitSphereResponsePlot < handle
    ...
    methods ( Access = public )
        ...
        function obj = UnitSphereResponsePlot( ...
            ...
            obj.response_axes.set_axes_position( widget_factory.adjust_axes_position( pos ) );
    ...
    methods ( Access = private )
        ...
        function figure_h = create_base_figure( obj, ...
            ...
            figure_h = widget_factory.create_figure( component_name );
            
            obj.static_text_h = widget_factory.add_point_information_text( figure_h );
            
            obj.listbox_h = widget_factory.add_objective_selection_listbox( ...
                figure_h, ...
                titles, ...
