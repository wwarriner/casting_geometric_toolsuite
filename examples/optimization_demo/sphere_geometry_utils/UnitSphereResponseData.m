classdef (Sealed) UnitSphereResponseData < handle
    ...
    methods ( Access = public )
        ...
        function obj = UnitSphereResponseData( ...
            ...
            obj.titles = objective_variables.title;
        ...
        function value = get_objective_value( ...
            ...
            value = obj.objective_values( phi_index, theta_index, objective_index );
        ...
        function values = get_quantile_values( obj, quantile, objective_index )
            ...
            threshold = obj.get_quantile_threshold_value( quantile, objective_index );
            values = values < threshold;
            
        end
        
        
        function decisions = get_minima_decisions_in_degrees( obj, objective_index )
        ...
        function value = get_quantile_threshold_value( obj, quantile, objective_index )
        ...
        function interpolants = generate_interpolants( ...
            ...
            for i = 1 : objective_count
                ...
                interpolants{ i } = generate_unit_sphere_scattered_interpolant( ...
                    ...
                    results{ :, objective_variables.title{ i } }, ...
