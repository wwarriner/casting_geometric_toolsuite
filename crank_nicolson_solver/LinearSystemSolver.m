...
%                 time_steps = [ next_step time_steps ];
                ...
                tic;
                time_steps = [ time_step_range( TIME_STEP_INDEX ) time_steps ];
                ...
                pre_m = ichol( lhs, struct( 'michol', 'on' ) );
                [ u, pcg_it ] = obj.solve_system_of_equations( lhs, rhs, pre_m, u_pcg_start );
                obj.pcg_count = obj.pcg_count + pcg_it;
                solve_time = solve_time + toc;

                tic;
                q = obj.pp.compute_melt_enthalpies( mesh, u );
                quality_ratios = [ obj.determine_solution_quality_ratio( q_prev, q ) quality_ratios ];
                ...
                time_step_range = obj.choose_next_time_step_range( ...
                    quality_ratios( 1 ), ...
                    time_step_range ...
                    );
    ...
    methods ( Access = private )
        ...
        function [ ...
            ...
            rhs_wts = m_r_wts * u_curr( : ) + bc_rhs_wts - bc_lhs_wts + dkdu_wts;
            
        end
        
        
        function [ u, pcg_it ] = solve_system_of_equations( obj, lhs, rhs, pre_m, start_point )
